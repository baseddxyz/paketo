...
nmap('<S-TAB>', '<Cmd>bprevious<CR>',                            'Go to previous buffer')
...
nmap_leader('fm', '<Cmd>lua require("conform").format()<CR>',   'Format')
...
nmap('gD', '<Cmd>lua vim.lsp.buf.declaration()<CR>',        'Source declaration')
nmap('<C-k>', '<Cmd>lua vim.lsp.buf.signature_help()<CR>',  'Signature help')
nmap_leader('D', '<Cmd>lua vim.lsp.buf.type_definition()<CR>', 'Type definition')
