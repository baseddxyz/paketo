...
-- Step one ===================================================================
-- Enable 'luna.nvim', a near-black colorscheme with restrained syntax accents.
-- It is installed in 'init.lua' so it is available for the first screen draw.
-- See the plugin's README for available customization options.
now(function()
  require('luna').setup({})
